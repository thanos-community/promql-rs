...
async fn the_plan_is_a_projection_over_a_scan_with_literal_parameters() {
    ...
    assert!(
        rendered.starts_with("Projection: selector_0.labels, promql_vector_selector(selector_0.samples, Int64(600000), Int64(1200000), Int64(30000), Int64(300000), Int64(30000), Int64(NULL), Utf8(\"plain\"), Int64(0)) AS samples"),
        "{rendered}"
    );
