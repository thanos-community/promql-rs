...
Against the vendored corpus: **306 of 2098 evals pass** (14.6%), and **646** are blocked on the features below.

## Missing features

| evals blocked | feature |
|---:|---|
| 200 | a binary operator |
