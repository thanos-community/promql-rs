...
Against the vendored corpus: **268 of 2098 evals pass** (12.8%), and **681** are blocked on the features below.
...
| 2 | the sort function |
| 2 | the time function |
| 2 | the topk aggregation with the scalar function as its parameter |
...
| 1 | the bottomk aggregation with the scalar function as its parameter |
| 1 | the ceil function |
