...
Against the vendored corpus: **283 of 2098 evals pass** (13.5%), and **773** are blocked on the features below.

## Missing features

| evals blocked | feature |
|---:|---|
| 248 | a binary operator |
...
| 13 | the round function |
| 13 | the timestamp function |
| 12 | a scalar literal |
| 11 | the topk aggregation |
